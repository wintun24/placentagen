...
class test_br_vol_in_grid(TestCase):
    ...
    def test_br_vol_sampling_grid(self):
        ...
        self.assertTrue(np.isclose(br_vol_in_grid['master_vol_samp_gr'][0,0],  0.01570796))
        self.assertTrue(np.isclose(br_vol_in_grid['master_vol_samp_gr'][0,1],  0.00314159))
